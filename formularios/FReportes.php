						...
						<div class="panel-body">
					    	...
					    	<div class="form-group">
					          <label for="f_inicial" class="tres">Fecha inicial:</label>
					            <div class="nueve">				
					                <input type="text" class="datepicker form-control tres" name="f_inicial" id="f_inicial" placeholder="dd/mm/aaaa" pattern="(0[1-9]|[12][0-9]|3[01])[/-](0[1-9]|1[012])[/-](19|20)\d\d" required>
					            </div>
					        </div>
					        <div class="form-group">
					            <label for="f_final" class="tres">Fecha final:</label>
					            <div class="nueve">
					                <input type="text" class="datepicker form-control tres" name="f_final" id="f_final" placeholder="dd/mm/aaaa" pattern="(0[1-9]|[12][0-9]|3[01])[/-](0[1-9]|1[012])[/-](19|20)\d\d" required>
					            </div>
					        </div>
					        <hr/>
							<button type="submit" name="accion" id="buscar" value="Generar" class="btn btn-success"><i class="fa fa-cogs"></i> Generar</button>
				            <?php
