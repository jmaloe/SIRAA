...
<html lang="es">
<head>
	<title>SIRAA Administrador</title>
	<meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1">
	<meta charset="utf-8" />
	<meta name="description" content="Administración de registros">
...
<body class="todo-contenido ancho">	
  <form id="AdminSIRAA" action="Admin.php" method="POST" enctype="multipart/form-data">  	
	<div class="panel panel-primary contenido">
    	<div class="panel-heading"><h4>Administración de datos</h4></div>
	 	<div class="panel-body">
	 		<p class="instruccion">
	 			Alta, eliminación y actualización de datos a nivel base de datos de las principales tablas del SIRAA.
			</p>
			<hr />
			<div class="content">
				...
				<p style="text-align:right">Fecha actual: <?php echo date("Y/M/d"); ?></p>
