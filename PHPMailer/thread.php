...
class Thread {
     ...
     */
    public function __construct($objeto, $_runnable = null ) {
        if( $_runnable !== null ) {
            $this->setRunnable($objeto, $_runnable );
        }
    }
     ...
     * @return callback
     */
    public function setRunnable($objeto, $_runnable ) {        
        if( self::runnableOk($objeto, $_runnable ) )
        {
     ...
     * @return boolean
     */
    public static function runnableOk($objeto, $_runnable ) {
        return ( method_exists($objeto, $_runnable ) && is_callable(array($objeto,$_runnable) ) );
    }
      ...
      try
      {
        ...
        else
        {
            ...
            if ( !empty( $arguments ) ) {
                ...
                echo "Llamando la funcion del usuario";
